...
<script type="text/javascript">
	...
	function showMsg(msg,uuid){
		...
		top.$('hid-action').value="menu_delete?model.uuid="+uuid;
		top.lock.show();
	}
</script>
			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="123">&nbsp;</td>
						<td width="62">菜单名称</td>
						<td width="142"><s:textfield name="mhq.name" size="18"/></td>
						<td width="60">所属菜单</td>
						<td width="149">
							<s:select name="mhq.parent.uuid" list="parentList" listKey="uuid" listValue="name" headerKey="-1" headerValue="----请-选-择----"/>
							<%-- <select class="kuan">
