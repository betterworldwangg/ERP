...
<script type="text/javascript">
	...
	function showMsg(msg,uuid){
		...
		top.$('hid-action').value="resource_delete?model.uuid="+uuid;
		top.lock.show();
	}
</script>
<div class="content-right">
	...
	<div class="content-text">
		<form action="resource_list" method="post">
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					style="font-size:14px; font-weight:bold; font-family:"黑体";">
					<tr>
						<td width="68" height="30">资源名称</td>
						<td width="123"><s:textfield name="rhq.name" size="18"/></td>
						<td width="62">资源类别</td>
						<td width="142">
							<select class="kuan">
						...
						<td width="70"><a href="resource_input"><img src="images/can_b_02.gif" border="0" /></a></td>
					</tr>
				</table>
			</div>
			<!--"square-o-top"end-->
