...
<div class="content-right">
	...
	<div class="content-text">
		<div class="square-order">
			<form action="store_save" method="post">
  			<div style="border:1px solid #cecece;">
				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="32%">
				      	<s:textfield name="model.address" size="25"/>
				      </td>
				    </tr>
				    <tr  bgcolor="#FFFFFF">
				      <td colspan="4">&nbsp;</td>
				    ...
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td colspan="3" width="32%">
				      	<s:select name="model.employee.uuid" list="employeeList" listKey="uuid" listValue="name"/>
