				...
				<table width="100%">
					<tr>
						<td width="50%" align="center">
							<s:if test="model.type== @org.erp.invoice.order.entity.OrderModel@ORDER_TYPE_BUY_BUYING">
								<s:a action="transport_endTask" style="color:#0f0;font-size:20px;padding-top:2px;font-weight:bold;text-decoration:none;width:82px;height:28px;display:block;background:url(images/btn_bg.jpg)">
