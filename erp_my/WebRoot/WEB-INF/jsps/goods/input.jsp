  			...
  			<div style="border:1px solid #cecece;">
				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="32%">
				      		<s:select id="supplier" name="model.goodTypeMode.supplierM.uuid" list="supplierList" listKey="uuid" listValue="name"/>
				      ...
				      <td width="32%">
				      		<s:select id="goodsType" name="model.goodTypeMode.uuid" list="goodsTypeList" listKey="uuid" listValue="name"/>
				      		<%-- <select style="width:190px">
								<option value="-1">----请-选-择----</option>
