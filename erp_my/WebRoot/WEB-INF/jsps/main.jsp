...
<body>
		...
		<div class="head">
			...
			<div class="head-right">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td width="32%">
							<a href="employee_changePwd" target="main">
		...
		<div class="content">
			<div class="left">
				...
				<div class="left-bottom">
					<%@ include file="/WEB-INF/jsps/page/menu.jsp" %>
				</div>
				<!--"left-bottom"end-->
			</div>
			<!--"left"end-->

			<iframe id="frame-contect" src="page_context"
				style="width:848px;float:right;height:530px" scrolling="yes"
	...
	<!--"container"end-->
	<%@include file="/WEB-INF/jsps/page/mask.jsp"%>
</body>
</html>
